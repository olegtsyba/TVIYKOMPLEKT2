...
// Порівняння БЕЗ УРАХУВАННЯ пробілів взагалі — не просто згортання
// зайвих/подвійних пробілів (цього недостатньо), а повне видалення
// пробільних символів з обох боків. Підтверджений живий кейс (лід 39425,
// 2026-09-10): реальний пункт меню KeyCRM — "Неактуально" одним словом
// БЕЗ пробілу, а класифікатор генерує "Не актуально" З пробілом — це
// різниця у НАЯВНОСТІ пробілу, а не в його кількості, тож звичайне
// згортання \s+ -> ' ' цей кейс не ловить (перевірено: досі падав з
// тією самою помилкою 3 рази в продакшн-циклі 2026-09-10T13:00 ПІСЛЯ
// першої спроби фіксу). Повне видалення пробілів безпечне: серед 15
// причин (REASONS у classify-leads.js) немає двох різних причин, що
// відрізнялись би лише пробілами.
