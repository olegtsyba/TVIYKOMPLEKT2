...
//
// ПІДТВЕРДЖЕНО (інциденти 17.08.2026 та 24.08.2026): саме цей сценарій
// "400 для обох токенів одночасно" — не TTL, а конфлікт сесій. KEYCRM_EMAIL
// в .env — особистий акаунт власниці KeyCRM, яка сама заходить у систему
// через звичайний браузер. KeyCRM дозволяє лише ОДНУ активну сесію на
// акаунт, тому її ручний логін миттєво інвалідовує серверну сесію
// автоматизації — обидва токени вмирають одночасно, незалежно від частоти
// heartbeat-крону. Деталі й довгострокове рішення (окремий службовий
// акаунт з урізаною роллю) — див. keycrm-leads-classifier/README.md,
// розділ "Якщо сесія раптово протухла повністю".
